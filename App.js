...
const AddBookScreen = () => {
  ...
  const handleBook = () => {
    ...
    const updatedBookTitles = [bookTitle, ...bookTitles.slice(0, 2)];
  ...
  return (
    <View>
      ...
      <Picker
        ...
        style={{ height: 50, width: 200, marginBottom: 0 }}
        onValueChange={(itemValue) => setSelectedGenre(itemValue)}
      >
        <Picker.Item label="Fiction" value="Fiction" />
        <Picker.Item label="History" value="History" />
        <Picker.Item label="Autobiography" value="Autobiography" />
        <Picker.Item label="Non-fiction" value="Non-ficton" />
      </Picker>
      <TextInput
        style={styles.placeholderTextAuthor}
      ...
      />
      <Button title="Add Book" onPress={handleBook} />
    </View>
  );
};
...
export default function App() {
  ...
  <Tab.Screen
    ...
    options={{ tabBarIcon: makeIconRender("question mark") }}
  />
</Tab.Navigator>
